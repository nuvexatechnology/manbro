...
export function HomeProductCard({ product }: HomeProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group bg-[#11301F]/80 border border-[#284234] rounded-2xl p-2.5 sm:p-3 hover:border-[#d4af37]/60 transition flex flex-col relative"
    >
      {/* Product Image */}
      <div className="relative aspect-[3/4] bg-[#082816] rounded-xl overflow-hidden mb-3">
        {cartItemCount > 0 && (
          <div className="absolute top-2 left-2 z-10">
            <span className="bg-[#d4af37] text-black font-black text-[9px] uppercase px-1.5 py-0.5 rounded shadow flex items-center gap-1">
        ...
        {product.images?.[0] ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <svg className="w-10 h-10 text-[#284234]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a0 0 002-2V6a0 0 00-2-2H6a0 0 00-2 2v12a0 0 002 2z" />
            </svg>
          </div>
        )}
      </div>
